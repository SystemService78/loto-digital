...
def realizar_login(email, senha):
    ...
    if email == "admin@admin.com" and senha == "admin123":
        ...
        st.session_state.usuario = {
            ...
            "EMAIL": email, 
            "AREA": "TI", 
            "PERFIL": "Perfil System", # Alterado de Admin
            "ATIVO": "Sim",
            "EMPRESA": "System Service"
    }
    st.rerun()
...
# --- 7. HISTÓRICO E DETALHAMENTO ---
    ...
    if not df_hist.empty:
        ...
        if st.session_state.id_os_detalhe is not None:
            ...
            st.title("📋 Todas as Execuções" if user_atual['PERFIL'] == 'Admin' else "📊 Visão Geral")
            ...
            with tab_cadastro:
                if user_p['PERFIL'] == 'Admin': # Proteção extra
                    ...
                    with st.container(border=True):
                        ...
                        # Lógica de Empresa: System vê tudo, Gerencial fica travado na dele
                        ...
                        if user_logado['PERFIL'] == 'Perfil System':
                            ...
                            # Trava na empresa do supervisor logado
                            st.text_input("Empresa", value=user_logado['EMPRESA'], key="reg_empresa", disabled=True)
