...
st.markdown("""
    ...
    /* 1. FORÇAR CORES GLOBAIS (INDETERMINADO PELO TEMA DO CELULAR) */
    html, body, [data-testid="stAppViewContainer"], [data-testid="stHeader"], .stApp {
        background-color: white !important;
        color: #1E293B !important;
    }

    /* 2. BLINDAGEM DE WIDGETS (INPUTS, SELECTS, EXPANDERS) */
    div[data-baseweb="select"] > div, 
    div[data-baseweb="input"] > div, 
    input, textarea, select {
        background-color: #F0F2F6 !important; /* Cinza bem clarinho para contraste */
        color: #1E293B !important;
        border: 1px solid #E2E8F0 !important;
    }
    
    /* Corrigir o texto dentro das listas de seleção e expansores */
    div[role="listbox"] div, [data-testid="stExpander"] div, [data-testid="stMarkdownContainer"] p {
        color: #1E293B !important;
    }

    /* 3. ESTILO DOS CARDS DE MÉTRICA (HOME) */
    .metric-container {
        background-color: white !important;
    ...
    /* 4. CENTRALIZAÇÃO DO BOTÃO "VER DETALHES" */
    div.stButton {
        text-align: center !important;
        width: 100% !important;
    }
    ...
    /* 5. CORES ESPECÍFICAS (FORÇAR PARA NÃO FICAR PRETO) */
