...
st.markdown("""
    <style>
    /* Estilo para transformar botões em cards de métrica clicáveis */
    ...
    .metric-label { font-size: 1.2rem !important; font-weight: 600 !important; color: #64748B !important; margin-bottom: 5px; }
    .metric-value-total { color: #1E3A8A !important; font-size: 3.5rem !important; font-weight: 800 !important; }
    .metric-value-exec { color: #3B82F6 !important; font-size: 3.5rem !important; font-weight: 800 !important; }
    .metric-value-conc { color: #10B981 !important; font-size: 3.5rem !important; font-weight: 800 !important; }
    .metric-value-canc { color: #EF4444 !important; font-size: 3.5rem !important; font-weight: 800 !important; }
...
if st.session_state.pagina_ativa == "🏠 Início":
    ...
    # --- 3. MÉTRICAS CLICÁVEIS (ESTILO ST.METRIC) ---
    st.write("##")
    c1, c2, c3, c4 = st.columns(4)

    # Cores originais: Azul, Azul Claro, Verde, Vermelho
    with c1:
        st.markdown('<div class="metric-card-btn">', unsafe_allow_html=True)
        # O label fica em fonte 1.2rem e o valor em 3.5rem (igual ao seu estilo original)
        label_total = f'<span style="font-size: 1.2rem; color: #64748B; font-weight: 600;">Total</span><br><span style="font-size: 3.5rem; color: #1E3A8A; font-weight: 800;">{total_finalizados + total_ativos + total_cancelados}</span>'
        if st.button(label_total, key="btn_h_total", help="Ver todas as execuções"):
    ...
    with c2:
        st.markdown('<div class="metric-card-btn">', unsafe_allow_html=True)
        label_exec = f'<span style="font-size: 1.2rem; color: #64748B; font-weight: 600;">Em Execução</span><br><span style="font-size: 3.5rem; color: #3B82F6; font-weight: 800;">{total_ativos}</span>'
        if st.button(label_exec, key="btn_h_ativos", help="Ver execuções em aberto"):
    ...
    with c3:
        st.markdown('<div class="metric-card-btn">', unsafe_allow_html=True)
        label_conc = f'<span style="font-size: 1.2rem; color: #64748B; font-weight: 600;">Concluídas</span><br><span style="font-size: 3.5rem; color: #10B981; font-weight: 800;">{total_finalizados}</span>'
        if st.button(label_conc, key="btn_h_conc", help="Ver execuções concluídas"):
    ...
    with c4:
        st.markdown('<div class="metric-card-btn">', unsafe_allow_html=True)
        label_canc = f'<span style="font-size: 1.2rem; color: #64748B; font-weight: 600;">Canceladas</span><br><span style="font-size: 3.5rem; color: #EF4444; font-weight: 800;">{total_cancelados}</span>'
        if st.button(label_canc, key="btn_h_canc", help="Ver execuções canceladas"):
