            ...
            with tab_cadastro:
                if user_p['PERFIL'] == 'Perfil System': # Proteção extra
                    ...
                    with st.container(border=True):
                        ...
                        c1, c2 = st.columns(2)
                        # Novas áreas conforme solicitado
                        lista_areas = ["Manutenção Mecânica", "Manutenção Elétrica", "Operação", "SESMT"]
                        c1.selectbox("Área", lista_areas, key="reg_area")
                        
                        # Novos perfis conforme solicitado
                        lista_perfis = ["Perfil Operação", "Perfil Gerencial Clientes", "Perfil System", "SESMT"]
                        # Se não for System, ele não pode criar outros System
                        if user_logado['PERFIL'] != 'Perfil System':
                            lista_perfis = ["Perfil Operação", "Perfil Gerencial Clientes", "SESMT"]
                            
                        c2.selectbox("Perfil", lista_perfis, key="reg_perfil")
