...
def executar_sql(query, params=()):
    """Traduz os nomes das chaves para minúsculo antes de executar"""
    query_up = query.upper()
    try:
        if "INSERT INTO USUARIOS" in query_up:
            # Aqui forçamos as chaves em minúsculo conforme criamos no SQL Editor
            dados = {
