...
st.markdown("""
    <style>
    /* Estilo do Card Branco (Idêntico ao st.metric) */
    .metric-container {
        ...
        height: 180px;
        position: relative; /* Necessário para o botão sobrepor */
        display: flex;
    ...
    /* Título (Igual ao Label do metric) */
    .metric-label-custom {
        color: #64748B;
        font-size: 1.1rem;
        font-weight: 600;
    ...
    /* Número Grande (Igual ao Value do metric) */
    .metric-value-custom {
        font-size: 3.5rem;
        font-weight: 800;
        display: block;
    ...
    /* O Pulo do Gato: Tornar o botão do Streamlit invisível e cobrindo o card todo */
    ...
    /* Remove qualquer efeito de clique/foco do botão invisível */
    .metric-container button:focus, .metric-container button:active {
        background-color: transparent !important;
...
# --- 3. MÉTRICAS CLICÁVEIS (VISUAL ORIGINAL) ---
    st.write("##")
