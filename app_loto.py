...
# --- 1. CONEXÃO ---
# --- TRATAMENTO DE EMERGÊNCIA PARA A CHAVE ---
if "connections" in st.secrets and "gsheets" in st.secrets.connections:
    # Remove barras extras e garante que as quebras de linha sejam reais
    st.secrets.connections.gsheets.private_key = st.secrets.connections.gsheets.private_key.replace("\\n", "\n")

# O Streamlit Cloud vai ler os segredos automaticamente daqui
