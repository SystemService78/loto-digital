    ...
    if not df_hist.empty:
        ...
        if st.session_state.id_os_detalhe is not None:
            ...
            if status_atual == "Todas":
                # Une os dois dataframes. ignore_index=True ajuda a evitar erros de índice
            ...
            with c_down_btn:
                if not df_para_excel.empty:
                    ...
                    with pd.ExcelWriter(buffer, engine='openpyxl') as writer:
                        # Garante colunas limpas para o Excel
                        df_excel_final = df_para_excel.loc[:, ~df_para_excel.columns.duplicated()].copy()
