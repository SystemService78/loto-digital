...
st.markdown("""
    ...
    /* 1. FORÇAR MODO CLARO TOTAL EM TODAS AS CAMADAS */
    [data-testid="stAppViewContainer"], [data-testid="stHeader"], [data-testid="stSidebar"], .stApp, 
    div[data-baseweb="select"], div[data-baseweb="input"], div[role="listbox"] {
        background-color: #F8F9FA !important;
        color: #1E293B !important;
    }

    /* 2. FORÇAR BRANCO NOS CAMPOS DE DIGITAÇÃO E LISTAS */
    input, textarea, [data-baseweb="select"] > div, div[role="option"] {
        background-color: white !important;
        color: #1E293B !important;
        border: 1px solid #E2E8F0 !important;
    }

    /* 3. CORRIGIR TEXTOS DE LABELS E EXPANSORES */
    [data-testid="stWidgetLabel"] p, [data-testid="stExpander"] p, label {
        color: #1E293B !important;
        font-weight: 600 !important;
    }

    /* 4. CENTRALIZAR BOTÃO "VER DETALHES" NA HOME */
    /* Target específico para os botões das colunas da Home */
...
# Perfil Adm
    ...
    if user_p['PERFIL'] in ['Perfil System', 'Perfil Gerencial Clientes']:
        ...
        escolha_aba_admin = st.radio(
            ...
            key="radio_admin_persistente", # A KEY SALVA O VALOR NO SISTEMA
            horizontal=True,
            label_visibility="collapsed"
        )
        # Atualiza o estado global toda vez que clicar
                    ...
                    with st.container(border=True):
                        ...
                        with c3:
                            ...
                            if st.button("Marcar como resolvido ✅", key=f"btn_sol_{row['ID']}", use_container_width=True):
                                ...
                                # FORÇA O SISTEMA A REABRIR NESTA ABA
