            ...
            if df_visualizacao.empty:
                ...
                for i, row in df_pagina_exibicao.iterrows():
                    if str(row.get('STATUS')) == "EM EXECUÇÃO":
                        ...
                        tempo_formatado = "---"
                        try:
                            # 1. Pegamos a hora atual oficial de Brasília
                            fuso_br = datetime.timezone(datetime.timedelta(hours=-3))
                            agora_br = datetime.datetime.now(fuso_br).replace(tzinfo=None) # Remove a "etiqueta" de fuso
                            ...
                            if h_ini_str:
                                ...
                                # 2. Se o início parece ser depois de "agora", ele certamente começou ontem
                                if dt_ini > agora_br:
                                ...
                                # Garante que não exiba negativo (mínimo 0)
