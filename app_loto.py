...
st.markdown("""
    ...
    /* FORÇAR MODO CLARO TOTAL */
    [data-testid="stAppViewContainer"], [data-testid="stHeader"], [data-testid="stSidebar"] {
        background-color: #F8F9FA !important;
        color: #1E293B !important;
    }

    /* FORÇAR TRANSPARÊNCIA DE IMAGENS E REMOVER FUNDO BRANCO DOS PNGs */
    img, [data-testid="stImage"] {
        background-color: transparent !important;
        mix-blend-mode: multiply; /* Faz o branco do fundo da imagem sumir se o fundo do app for claro */
    }

    /* Garante que textos do menu e títulos fiquem escuros */
                    ...
                    if str(row.get('STATUS')) == "EM EXECUÇÃO":
                        ...
                        try:
                            ...
                            if h_ini_str:
                                ...
                                # CALCULO REAL: Se o resultado for negativo, subtraímos 1 dia da data inicial (começou ontem)
                                diff = agora_br - dt_ini
                                total_sec = int(diff.total_seconds())
                                
                                if total_sec < 0: # Caso o fuso ou a virada de dia jogue o início para "depois" de agora
...
# Perfil Adm
    ...
    if user_p['PERFIL'] in ['Perfil System', 'Perfil Gerencial Clientes']:
        ...
        escolha_aba_admin = st.radio(
            ...
            opcoes_admin, 
            key="aba_admin_persistente", # A KEY fixa mantém o usuário na mesma aba após st.rerun()
            horizontal=True,
